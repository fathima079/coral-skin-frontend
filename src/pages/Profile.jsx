    ...
    const fetchProfile = async () => {
      try {
        ...
        const res = await axios.get(
          "https://coral-skin-backend.onrender.com/api/auth/profile",
          {
            headers: {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#FAF9F6] flex items-center justify-center">
        <div className="animate-pulse text-[#8A9A8A] tracking-widest uppercase text-xs">
          Loading Ritual...
        </div>
      </div>
    );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-[#2D3A3A] mt-2">
            HELLO,{" "}
            <span className="italic font-light text-[#8A9A8A] uppercase">
              {user.name.split(" ")[0]}.
            </span>
          </h1>
        </div>
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-[30px] p-8 md:p-12 shadow-sm border border-black/5">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-black/5 pb-6">
                  <div>
                    ...
                    <p className="text-lg text-[#2D3A3A] capitalize">
                      {user.role} Member
                    </p>
                  </div>
              ...
              <div className="mt-12 p-8 bg-[#8A9A8A]/5 rounded-3xl border border-[#8A9A8A]/10">
                <p className="text-[#8A9A8A] text-sm italic">
